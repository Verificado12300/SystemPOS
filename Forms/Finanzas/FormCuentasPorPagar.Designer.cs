namespace SistemaPOS.Forms.Finanzas
{
    partial class FormCuentasPorPagar
    {
        ...
        {
            // ── Palette: Indigo SaaS ──────────────────────────────────────────
            // Primary (79,70,229) | Warning (245,158,11) | Danger (239,68,68)
            // Success (16,185,129)| Bg (248,250,252) | Text (30,41,59)
            ...
            // ═══════════════════════════════════════════════════════════════════
            // pnlHeader  ─ Amber/Warning toned (distinct from Gastos)
            // Using deep amber-indigo: (79,70,229) same brand, distinct accent
            // ═══════════════════════════════════════════════════════════════════
            ...
            this.lblHeaderSub.Text      = "Obligaciones pendientes con proveedores";
            ...
            this.btnExportar.Location                          = new System.Drawing.Point(1082, 24);
            ...
            // ═══════════════════════════════════════════════════════════════════
            // pnlKpi — 3 cards: Total pendiente | Proveedores | Documentos
            // ═══════════════════════════════════════════════════════════════════
            ...
            this.lblKpi1Val.ForeColor = System.Drawing.Color.FromArgb(239, 68, 68);
            ...
            this.lblKpi1Lbl.Text      = "TOTAL POR PAGAR";

            // Card 2 — Proveedores (indigo)
            ...
            this.lblKpi2Lbl.Text      = "PROVEEDORES";
            ...
            // ═══════════════════════════════════════════════════════════════════
            // pnlFiltros — White filter bar, 2 rows (search+estado / desde+hasta)
            // ═══════════════════════════════════════════════════════════════════
            ...
            this.cmbEstado.Items.AddRange(new object[] { "Todos los estados", "PENDIENTE", "PARCIAL", "PAGADO", "ANULADO" });
            this.cmbEstado.Location          = new System.Drawing.Point(296, 26);
            this.cmbEstado.Name              = "cmbEstado";
            this.cmbEstado.Size              = new System.Drawing.Size(172, 26);
            this.cmbEstado.TabIndex          = 1;

            // Row 2: desde / hasta / filtrar button
            ...
            this.btnFiltrar.BackColor                         = System.Drawing.Color.FromArgb(238, 242, 255);
            this.btnFiltrar.Cursor                            = System.Windows.Forms.Cursors.Hand;
            this.btnFiltrar.FlatAppearance.BorderColor        = System.Drawing.Color.FromArgb(199, 210, 254);
            this.btnFiltrar.FlatAppearance.BorderSize         = 1;
            this.btnFiltrar.FlatAppearance.MouseOverBackColor = System.Drawing.Color.FromArgb(224, 231, 255);
            this.btnFiltrar.FlatStyle                         = System.Windows.Forms.FlatStyle.Flat;
            this.btnFiltrar.Font                              = new System.Drawing.Font("Segoe UI", 9F, System.Drawing.FontStyle.Bold);
            this.btnFiltrar.ForeColor                         = System.Drawing.Color.FromArgb(79, 70, 229);
            ...
            this.lblTotalRegistros.Text      = "0 proveedores";
            ...
            this.lblTotalPendiente.Text      = "Total por pagar:";
            ...
            this.txtTotalPendiente.ForeColor   = System.Drawing.Color.FromArgb(239, 68, 68);
            ...
            this.colDocumentos.DefaultCellStyle.ForeColor = System.Drawing.Color.FromArgb(79, 70, 229);

            this.colTotalCompras.HeaderText = "TOTAL";
            ...
            this.colTotalCompras.DefaultCellStyle.Font      = new System.Drawing.Font("Segoe UI", 9.5F);
            ...
            this.colTotalPendiente.DefaultCellStyle.ForeColor = System.Drawing.Color.FromArgb(239, 68, 68);
